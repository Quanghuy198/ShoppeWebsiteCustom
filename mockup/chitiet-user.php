...
<!-- 
                ...
                <div class="header_search">
                    ...
                    <div class="header__logo hide-on-tablet">
                        <a href="user.php?email_user=<?php echo $email_user;?>&pass_user=<?php echo $_GET['pass_user'] ?>" class="logo_link"><img src="./image/logoHG.png" alt="Photo"
                    ...
                    <div class="col l-7">
                        <div class="chitiet_info">
                            ...
                            <div class="chitiet_info_soluong">
                                ...
                                <input type="number" class="chitiet_info_soluong_quantity" id="amount_order">
                            ...
                            <div class="chitiet_info_btn">
                                <button class="btn-add-into-cart" id="btn-add-cart" type="button">Thêm Vào Giỏ Hàng</button>
                                <button class="btn-mua-ngay" id="btn_buy" type="submit">Mua Ngay</button>
                            </div>
                        </div>

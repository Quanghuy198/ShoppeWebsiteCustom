    ...
    <script>
        $(document).ready(function(){
            $("#txt_email").blur(function(){
                var value=$(this).val()
                // alert(value)
                $.get("./ajax/check-email-dk.php", {email:value}, function(data){
                    if( data != 0 ){
                        $("#mess_email_dk").html("Email đã tồn tại")
                        $("#mess_email_dk").css("color","red")
                    }
                    else{
                        $("#mess_email_dk").html("Email hợp lệ")
                        $("#mess_email_dk").css("color","blue")
                    }
                })
            })
            $("#txt_email").focus(function(){
                $("#mess_email_dk").html("Bạn có thể sử dụng chữ cái, số và dấu chấm")
                $("#mess_email_dk").css("color","black")
            })

            $("#txt_repass").blur(function(){
                var val_pass=$("#txt_pass").val()
                var val_repass=$("#txt_repass").val()
                if( val_pass != val_repass ){
                    $("#mess_pass_dk").html("Mật khẩu không khớp")
                    $("#mess_pass_dk").css("color","red")
                }
                else{
                    $("#mess_pass_dk").html(" ")
                }
                        ...
                        <div class="home_procduct">
                            ...
                            <?php foreach($datar as $r){?>
                                <div class="col l-2-4 m-4 c-6">
                                    <a class="home_product_item" href="chitiet.php?product_id=<?php echo $r['product_id']?>">
                        ...
                        <div class="auth-form_container">
                            ...
                            <div class="auth-form_form">
                                <div class="auth-form_form_group">
                                    <input type="text" class="auth-form_form_input" placeholder="Email của bạn" name="email_dk" id="txt_email">
                                    <div id="mess_email_dk">Bạn có thể sử dụng chữ cái, số và dấu chấm</div>

                                </div>

                                <div class="auth-form_form_group">
                                    <input type="password" class="auth-form_form_input" placeholder="Mật khẩu của bạn" name="pass_dk" id="txt_pass">
                                </div>

                                <div class="auth-form_form_group">
                                    <input type="password" class="auth-form_form_input" placeholder="Nhập lại mật khẩu" name="repass_dk" id="txt_repass">
                                    <div id="mess_pass_dk" ></div>
                                </div>
